...
setwd("C:/Users/saura/OneDrive/Desktop/Project/Getting-and-Cleaning-Data/UCI HAR Dataset")
...
write.table(total_mean, file = "C:/Users/saura/OneDrive/Desktop/Project/Getting-and-Cleaning-Data/tidydata.txt", row.names = FALSE, col.names = TRUE)
